...
INSERT INTO USERS VALUES(SEQ_USER_ID.nextval,SEQ_ADMIN_ID.currval, 'John', 'Doe', TO_DATE('01-JAN-1980', 'DD-MON-YYYY'), 1234567890, 'johndoe@example.com', 123, 'Main St', 'Anytown', 'CA', 'US', 'CUSTOMER');
...
INSERT INTO USERS VALUES(SEQ_USER_ID.nextval,SEQ_ADMIN_ID.currval, 'Jane', 'Doe', TO_DATE('02-FEB-1985', 'DD-MON-YYYY'), 2345678901, 'janedoe@example.com', 456, 'Broadway', 'Sometown', 'NY','US', 'CUSTOMER');
...
INSERT INTO METERBOARD VALUES (SEQ_METER_ID.nextval, SEQ_USER_ID.currval, 123, 'Cedar St', 'Anytown', 'NY', 'US', 90, TO_DATE('15-MAR-2022', 'DD-MON-YYYY'), TO_DATE('10-DEC-2023', 'DD-MON-YYYY'));
...
INSERT INTO METERBOARD VALUES (SEQ_METER_ID.nextval, SEQ_USER_ID.currval, 456, 'Pine Ave', 'Anycity', 'CA',  'US', 150, TO_DATE('17-APR-2022', 'DD-MON-YYYY'), TO_DATE('15-DEC-2023', 'DD-MON-YYYY'));
...
INSERT INTO METERBOARD VALUES (SEQ_METER_ID.nextval, SEQ_USER_ID.currval, 789, 'Main St', 'Anycity', 'FL',  'US', 100, TO_DATE('20-MAY-2022', 'DD-MON-YYYY'), TO_DATE('28-DEC-2023', 'DD-MON-YYYY'));
INSERT INTO METERBOARD VALUES (SEQ_METER_ID.nextval, SEQ_USER_ID.currval, 234, 'Elm St', 'Anytown', 'NY', 'US', 120, TO_DATE('10-JAN-2023', 'DD-MON-YYYY'), TO_DATE('31-DEC-2023', 'DD-MON-YYYY'));
